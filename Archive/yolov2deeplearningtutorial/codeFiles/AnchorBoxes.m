...
allBoxes = vertcat(trainingData.Green_Cube{:},trainingData.Green_Cylinder{:},trainingData.Red_Cube{:},trainingData.Red_Cylinder{:},trainingData.Blue_Cube{:},trainingData.Blue_Cylinder{:});
