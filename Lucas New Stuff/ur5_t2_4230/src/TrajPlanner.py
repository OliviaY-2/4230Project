...
TaskPub = rospy.Publisher('TaskComplete', String, queue_size=10)
GripperPub = rospy.Publisher('Gripper', String, queue_size=1)
...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def plan_cartesian_path(self,CoordX,CoordY):
  # Copy class variables to local variables to make the web tutorials more clear.
  # In practice, you should use the class variables directly unless you have a good
  # reason not to.
    scale = 1
   ...
   # wpose = move_group.get_current_pose().pose
    ...
    wpose.position.x = data_x
    wpose.position.y = data_y
  ...
  def plan_bin_path(self,CoordX,CoordY):
    # Copy class variables to local variables to make the web tutorials more clear.
    # In practice, you should use the class variables directly unless you have a good
    # reason not to.
      scale = 1
